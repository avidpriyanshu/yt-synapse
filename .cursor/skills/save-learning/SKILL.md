...
4. If confirmed, run:
   ```bash
   /Users/avid/.nvm/versions/node/v22.15.1/bin/caliber learn add "<refined learning>"
   ```
   For personal preferences (not project-level), add `--personal`:
   ```bash
   /Users/avid/.nvm/versions/node/v22.15.1/bin/caliber learn add --personal "<refined learning>"
   ```
...
-> If yes: run `/Users/avid/.nvm/versions/node/v22.15.1/bin/caliber learn add "**[convention]** Push feature commits to the next branch, not master"`
